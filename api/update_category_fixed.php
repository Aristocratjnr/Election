...
try {
    ...
    // Get studentID instead of adminID
    // In a real fix, you would need to determine which student's ID to use
    // For now, we'll use the first student record we find
    ...
    // Update category - removed the description field and use studentID for updatedBy
